...
//Color
let INCOMING_MESSAGE_BUBBLE_COLOR = UIColor(red: 224/255.0, green: 224/255.0, blue: 224/255.0, alpha: 1.0)
...
//Bubble
let VERTICAL_PADDING_BETWEEN_MESSAGE_BUBBLE_AND_CELL : CGFloat = 5.0
...
let MESSAGE_BUBBLE_CORNER_RADIUS : CGFloat = 20.0
